...
public class HotelServiceTest extends AbstractTestNGSpringContextTests {
    ...
    public void testGetGuestsWithReservations() throws HotelServiceException {
    ...
    @DirtiesContext
    public void testMessageWhenNoReservationFound() throws HotelServiceException {
    ...
    public void testGetRoomByNumber() throws HotelServiceException {
    ...
    public void testMessageWhenRoomWithSpecifiedNumberNotFound() throws HotelServiceException {
    ...
    public void testGetRoomByType(RoomType roomType) throws HotelServiceException {
    ...
    public void testMessageWhenRoomsOfSpecifiedTypeNotFound() throws HotelServiceException {
        hotelService.getRooms(RoomType.DELUXE_DOUBLE);
    }


    @Test(description = "Verify service returns rooms reserved by specific user")
    public void testGetRoomsReservedByUser() throws HotelServiceException {
    ...
    public void testMessageWhenNoReservationsForSpecifiedGuestFound() throws HotelServiceException {
    ...
    public void testGetRoomsByPrice(double test1, double test2) throws HotelServiceException {
    ...
    public void testMessageWhenNoRoomsOfSpecifiedPricesFound() throws HotelServiceException {
        hotelService.getRooms(0, 5.5);
    }


    @Test(description = "Verify service return guest by name")
    public void testGetGuestByName() throws HotelServiceException {
    ...
    public void testMessageWhenGuestWithSpecifiedNameNotFound() throws HotelServiceException {
    ...
    public void testGetAvailableRooms() throws HotelServiceException {
    ...
    @Test(description = "Verify message when there is no available rooms",
            expectedExceptions = HotelServiceException.class,
            expectedExceptionsMessageRegExp = "All rooms are reserved!")
    @DirtiesContext
    public void testMessageWhenNoAvailableRoomsFound() throws HotelServiceException {
    ...
    public void testGetAvailableRoomsByType(RoomType roomType) throws HotelServiceException {
    ...
    @DirtiesContext
    public void testMessageWhenNoAvailableRoomsOfSpecificTypeFound() throws HotelServiceException {
    ...
    @DirtiesContext
    public void testReserveRoomWhenAmountOfGuestMoneySameAsRoomPrice() throws HotelServiceException {
        Guest guest = hotelService.getAllGuests().get("Bob Smith");
        Room room = hotelService.getRoomByNumber("1C");
    ...
    public void testMessageWhenNotEnoughMoneyForReservation() throws HotelServiceException {
    ...
    public void testMessageWhenRoomIsNotAvailableForReservation() throws HotelServiceException {
    ...
    @DirtiesContext
    public void testCancelReservation() throws HotelServiceException {
        SoftAssert softAssert = new SoftAssert();
        Guest guest = hotelService.getAllGuests().get("Tom Brown");
    ...
    public void testMessageWhenCancelReservationOfAvailableRoom() throws HotelServiceException {
    ...
    public void testCancelReservationByGuestWhenRoomReservedByAnotherGuest() throws HotelServiceException {
